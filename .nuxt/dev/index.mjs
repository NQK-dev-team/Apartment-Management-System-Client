...
import wsAdapter from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/crossws/dist/adapters/node.mjs';
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getCookie, setCookie, defineWebSocketHandler, getResponseStatusText } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/h3/dist/index.mjs';
import dayjs from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/dayjs/dayjs.min.js';
import WebSocket from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/ws/wrapper.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/devalue/index.js';
import destr from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/vue/index.mjs';
import { hash } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://H:/Projects/Appartment-Management-System-Client/node_modules/@unhead/shared/dist/index.mjs';
...
const _1tZmJtxlCI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "H:/Projects/Appartment-Management-System-Client";
...
const _lazy_CpN5nb = () => Promise.resolve().then(function () { return ____path_$3; });
const _lazy_XTUsPP = () => Promise.resolve().then(function () { return ____path_$1; });
const _lazy_QOsGhB = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/**:path', handler: _lazy_CpN5nb, lazy: true, middleware: false, method: undefined },
  { route: '/ws/**:path', handler: _lazy_XTUsPP, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_QOsGhB, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QOsGhB, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"H:/Projects/Appartment-Management-System-Client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"H:\\Projects\\Appartment-Management-System-Client","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"H:\\Projects\\Appartment-Management-System-Client\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"H:\\Projects\\Appartment-Management-System-Client\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"H:\\Projects\\Appartment-Management-System-Client\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"H:\\Projects\\Appartment-Management-System-Client\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const apiRoutes = {
  ...
  building: {
    list: (getAll = false) => `/building?getAll=${getAll}`,
    detail: (buildingId) => `/building/${buildingId}`,
    room: (buildingId) => `/building/${buildingId}/room`,
    getRoom: (buildingId, roomId) => `/building/${buildingId}/room/${roomId}`,
    getRoomContracts: (buildingId, roomId) => `/building/${buildingId}/room/${roomId}/contracts`,
    getRoomTickets: (buildingId, roomId, startDate = "", endDate = "") => `/building/${buildingId}/room/${roomId}/tickets?startDate=${startDate}&endDate=${endDate}`,
    deleteRoomContracts: (buildingId, roomId) => `/building/${buildingId}/room/${roomId}/delete-contracts`,
    updateRoom: (buildingId, roomId) => `/building/${buildingId}/room/${roomId}/update`,
    add: "/building/add",
    delete: (buildingID) => `/building/${buildingID}`,
    getSchedule: (buildingID) => `/building/${buildingID}/schedule`,
    updateBuilding: (buildingID) => `/building/${buildingID}/update`,
    buildingStatistic: (buildingID = void 0, year = dayjs().year()) => {
      if (buildingID) {
  ...
  room: {
    getList: "/room",
    getDetail: (roomId) => `/room/${roomId}`,
    getTicket: (roomId) => `/room/${roomId}/support-ticket`
  },
  profile: {
  ...
  staff: {
    ...
    add: "/staff/add",
    update: (staffId) => `/staff/${staffId}/update`,
    deleteMany: "/staff/delete-many",
    getSchedule: (staffId) => `/staff/${staffId}/schedule`,
    getContract: (staffId) => `/staff/${staffId}/contract`,
    getTicket: (staffId, limit = 500, offset = 0, startDate = "", endDate = "") => `/staff/${staffId}/ticket?limit=${limit}&offset=${offset}&startDate=${startDate}&endDate=${endDate}`
  },
  customer: {
    list: (limit = 500, offset = 0) => `/customer?limit=${limit}&offset=${offset}`,
    detail: (customerId) => `/customer/${customerId}`,
    add: "/customer/add",
    edit: (customerId) => `/customer/${customerId}/edit`,
    deleteMany: "/customer/delete-many",
    getContract: (customerId) => `/customer/${customerId}/contract`,
    getTicket: (customerId) => `/customer/${customerId}/ticket`,
    getTotal: `/customer/total`
  },
  bill: {
    list: (limit = 500, offset = 0, startMonth = "", endMonth = "") => `/bill?limit=${limit}&offset=${offset}&startMonth=${startMonth}&endMonth=${endMonth}`,
    detail: (billId) => `/bill/${billId}`,
    add: "/bill/add",
    edit: (billId) => `/bill/${billId}/edit`,
    deleteMany: "/bill/delete-many",
    update: (billId) => `/bill/${billId}/update`,
    initPayment: (billId) => `/bill/${billId}/init-payment`,
    momoConfirm: `/bill/:id/momo-confirm`,
    getStatistic: (year = dayjs().year()) => `/bill/statistic?year=${year}`
  },
  support_ticket: {
    approve: (ticketId) => `/support-ticket/${ticketId}/approve`,
    deny: (ticketId) => `/support-ticket/${ticketId}/deny`,
    getList: (limit = 500, offset = 0, startDate = "", endDate = "") => `/support-ticket?limit=${limit}&offset=${offset}&startDate=${startDate}&endDate=${endDate}`,
    deleteMany: "/support-ticket/delete-many",
    update: (ticketId) => `/support-ticket/${ticketId}/update`,
    add: "/support-ticket/add"
  },
  notice: {
    add: `/notification/add`,
    inbox: (limit = 500, offset = 0) => `/notification/inbox?limit=${limit}&offset=${offset}`,
    readNotification: (notificationId) => `/notification/${notificationId}/read`,
    unreadNotification: (notificationId) => `/notification/${notificationId}/unread`,
    markNotification: (notificationId) => `/notification/${notificationId}/mark`,
    unmarkNotification: (notificationId) => `/notification/${notificationId}/unmark`,
    getSent: (limit = 500, offset = 0) => `/notification/sent?limit=${limit}&offset=${offset}`,
  ...
  contract: {
    list: (limit = 500, offset = 0) => `/contract?limit=${limit}&offset=${offset}`,
    detail: (contractId) => `/contract/${contractId}`,
    add: "/contract/add",
    edit: (contractId) => `/contract/${contractId}/update`,
    deleteMany: "/contract/delete-many",
    bill: (contractId) => `/contract/${contractId}/bill`,
    activeList: (limit = 500, offset = 0) => `/contract/active-list?limit=${limit}&offset=${offset}`,
    getStatistic: `/contract/statistic`
  },
  upload: {
    getUploadFiles: (type) => `upload/not-process?type=${type}`,
    getProcessedFiles: (type, date) => `upload/processed?type=${type}&date=${date}`,
...
function getUserImageFromJWT(token) {
  if (!token) {
    return "";
  }
  const jwtPayload = token.split(".")[1];
...
function getUserNoFromJWT(token) {
  if (!token) {
    return "";
  }
  const jwtPayload = token.split(".")[1];
...
function getTicketByPassPermission(token) {
  if (!token) {
    return "0";
  }
  const jwtPayload = token.split(".")[1];
...
const COMMON = {
  ...
  UPLOAD_FILE_SIZE_LIMIT: 20 * 1024 * 1024,
  // 20MB
  ...
  const response = await proxyRequest(event, apiUrl, {
    ...
    onResponse: async (e, response2) => {
      ...
      if (apiUrl.includes(momoConfirmPathParts[1]) && apiUrl.includes(momoConfirmPathParts[3])) {
        ...
        } else if (body.message === getMessageCode("INVALID_PARAMETER") || body.message === getMessageCode("IPN_PAYLOAD_INVALID")) {
...
const ____path_ = defineWebSocketHandler({
  async open(peer) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
    const jwtCookie = (_c = (_b = (_a = peer.request) == null ? void 0 : _a.headers) == null ? void 0 : _b.get("cookie")) == null ? void 0 : _c.split("; ").find((row) => row.startsWith("jwt="));
    if (!jwtCookie) {
      peer.close();
    } else {
      const jwt = jwtCookie.split("=")[1];
      if (!await verifyToken(jwt)) {
        const refreshTokenCookie = (_f = (_e = (_d = peer.request) == null ? void 0 : _d.headers) == null ? void 0 : _e.get("cookie")) == null ? void 0 : _f.split("; ").find((row) => row.startsWith("refreshToken="));
    ...
    const config = useRuntimeConfig();
    const preprocessedPath = ((_k = peer.websocket.url) == null ? void 0 : _k.replace(
      `${(_h = (_g = peer.request) == null ? void 0 : _g.headers) == null ? void 0 : _h.get("x-forwarded-proto")}://${(_j = (_i = peer.request) == null ? void 0 : _i.headers) == null ? void 0 : _j.get("host")}/ws`,
      ""
    )) || "";
    let _externalWSPath = "";
    let userID = 0;
    ...
    if (splitResult.length > 1) {
      ...
      const queryParams = preprocessedPath.split("?")[1].split("&").filter((param) => !param.startsWith("clientUserID="));
      userID = Number(
        ((_l = preprocessedPath.split("?")[1].split("&").find((param) => param.startsWith("clientUserID="))) == null ? void 0 : _l.split("=")[1]) || 0
      );
...
const getClientManifest = () => import('file://H:/Projects/Appartment-Management-System-Client/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://H:/Projects/Appartment-Management-System-Client/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
