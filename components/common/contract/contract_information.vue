    ...
    <a-row :gutter="16">
      ...
      <a-col :span="6">
        <a-form-item :name="['contract', 'value']" :label="$t('contract_value')"
          :rules="[{ type: 'number', required: true }]">
          <a-input v-model:value="formState.contract.value" />
        </a-form-item>
      </a-col>
      <a-col :span="6">
        <a-form-item :name="['contract', 'created']" :label="$t('created_date')"
          :rules="[{ type: 'date', required: true }]">
          <a-date-picker v-model:value="formState.contract.created" />
        </a-form-item>
      </a-col>
    </a-row>
    <a-row :gutter="16">
      <a-col :span="6">
        <a-form-item :name="['contract', 'signed']" :label="$t('signed_date')"
          :rules="[{ type: 'date', required: true }]">
          <a-date-picker v-model:value="formState.contract.signed" />
        </a-form-item>
      </a-col>
      <a-col :span="6">
        <a-form-item :name="['contract', 'active']" :label="$t('active_date')"
          :rules="[{ type: 'date', required: true }]">
          <a-date-picker v-model:value="formState.contract.active" />
        </a-form-item>
      </a-col>
      <a-col :span="6">
        <a-form-item :name="['contract', 'expire']" :label="$t('expire_date')"
          :rules="[{ type: 'date', required: true }]">
          <a-date-picker v-model:value="formState.contract.expire" />
        </a-form-item>
      </a-col>
      <a-col :span="6">
